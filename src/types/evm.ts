...
export const StorageEvmTransactionSchema = z.object({
    hash: z
        .string()
        .refine((obj) => isValidEVMHash(obj), { message: 'Invalid EVM hash' }),
    from: z
        .string()
        .optional()
        .refine((obj) => isValidAddress(obj) || obj === undefined, {
            message: 'Invalid address',
        }),
    trx_index: z.number(),
    block: z.number(),
    block_hash: z.string().refine((obj) => isValidUnprefixedEVMHash(obj), {
        message: 'Invalid unprefixed EVM hash',
    }),
    to: z
        .string()
        .optional()
    ...
    input_data: z
        .string()
        .refine((obj) => isValidHexString(obj) || obj === '', {
    ...
    value: z.string().refine(isValidUnprefixedHexString, {
        message: 'Invalid unprefixed hex string',
    }),
    value_d: z.string().refine(
        (obj) => {
            try {
    ...
    logsBloom: z
        .string()
        .optional()
        .refine((obj) => isValidUnprefixedHexString(obj) || obj === undefined, {
            message: 'Invalid unprefixed hex string',
        }),
...
export type StorageEosioGenesisDelta = z.infer<
    typeof StorageEosioGenesisDeltaSchema
>;
